...
// Thanks OpenMods <3
// https://github.com/OpenMods/OpenModsLib/blob/fb08855cb638dca2d025953e5157a2bcd5d3aba4/src/main/java/openmods/utils/render/FramebufferBlitter.java
...
public abstract class FramebufferBlitter {
    ...
    public static boolean setup(Logger log) {
        FramebufferBlitter.Log = log;
